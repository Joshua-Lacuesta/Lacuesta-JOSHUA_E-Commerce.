...
const pageViews = {
  ...
  Wishlist: {
    ...
    content: `<div class="wishlist-grid"><article class="card wishlist-item"><div class="product-art product-image"><img src="assets/ballpen.jpg" alt="TAU Black Ballpen"><span>WRITE</span></div><h3>TAU Black Ballpen</h3><p>Smooth black ballpen for classes and campus work.</p><strong>PHP 49.00</strong><button class="primary-button add-cart">Move to cart</button></article><article class="card wishlist-item"><div class="product-art product-image"><img src="assets/rice.jpg" alt="Local Harvest Basket"><span>HARVEST</span></div><h3>Local Harvest Basket</h3><p>Fresh produce selected from partner growers.</p><strong>PHP 499.00</strong><button class="primary-button add-cart">Move to cart</button></article><article class="card wishlist-item"><div class="product-art product-image"><img src="assets/seed-starter.jpg" alt="Organic Seed Starter Kit"><span>SEEDS</span></div><h3>Organic Seed Starter Kit</h3><p>A simple beginning for your next growing project.</p><strong>PHP 349.00</strong><button class="primary-button add-cart">Move to cart</button></article></div>`
  },
  Profile: {
    eyebrow: 'Account',
